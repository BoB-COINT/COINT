# Generated by Django 5.2.7 on 2025-12-08 07:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pair_creator', models.CharField(max_length=42)),
                ...
                ('token_creator_addr', models.CharField(blank=True, help_text='Token creator address', max_length=42, null=True)),
                ('symbol', models.CharField(blank=True, help_text='Token symbol', max_length=20, null=True)),
                ('name', models.CharField(blank=True, help_text='Token name', max_length=100, null=True)),
                ('holder_cnt', models.IntegerField(blank=True, help_text='Total number of token holders', null=True)),
            ],
            options={
                'db_table': 'token_info',
                'ordering': ['-id'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_unformed_lp', models.IntegerField(default=0)),
                ('risk_score', models.JSONField(help_text='Final scam score calculated after analysis')),
                ('scam_types', models.CharField(help_text='Detected scam categories', max_length=100)),
                ('exitInsight', models.JSONField()),
                ('honeypotMlInsight', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_unformed_lp', models.IntegerField(default=0, help_text='Is not Unformed-LP')),
                ('probability', models.FloatField(blank=True, help_text='Exit scam probability (0-1)', null=True)),
                ('tx_cnt', models.IntegerField(blank=True, null=True)),
                ('timestamp', models.DateTimeField(blank=True, null=True)),
                ('tx_hash', models.CharField(blank=True, max_length=66, null=True)),
                ('reserve_base_drop_frac', models.FloatField(blank=True, null=True)),
                ('reserve_quote', models.FloatField(blank=True, null=True)),
                ('reserve_quote_drop_frac', models.FloatField(blank=True, null=True)),
                ('price_ratio', models.FloatField(blank=True, null=True)),
                ('time_since_last_mint_sec', models.FloatField(blank=True, null=True)),
                ('liquidity_age_days', models.FloatField(blank=True, null=True)),
                ('reserve_quote_drawdown_global', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_honeypot', models.BooleanField(help_text='Honeypot prediction result (y_pred)')),
                ('probability', models.FloatField(help_text='Honeypot probability (y_proba, 0-1)')),
                ('risk_level', models.CharField(blank=True, help_text='Risk level: CRITICAL/HIGH/MEDIUM/LOW/VERY_LOW', max_length=20, null=True)),
                ('threshold', models.FloatField(blank=True, help_text='Decision threshold from model', null=True)),
                ('top1_feat', models.CharField(blank=True, help_text='Most important feature name (rank 1)', max_length=64, null=True)),
                ('top1_feat_value', models.FloatField(blank=True, help_text='Value of top1 feature on this token', null=True)),
                ('top2_feat', models.CharField(blank=True, help_text='Feature name (rank 2)', max_length=64, null=True)),
                ('top2_feat_value', models.FloatField(blank=True, help_text='Value of top2 feature on this token', null=True)),
                ('top3_feat', models.CharField(blank=True, help_text='Feature name (rank 3)', max_length=64, null=True)),
                ('top3_feat_value', models.FloatField(blank=True, help_text='Value of top3 feature on this token', null=True)),
                ('top4_feat', models.CharField(blank=True, help_text='Feature name (rank 4)', max_length=64, null=True)),
                ('top4_feat_value', models.FloatField(blank=True, help_text='Value of top4 feature on this token', null=True)),
                ('top5_feat', models.CharField(blank=True, help_text='Feature name (rank 5)', max_length=64, null=True)),
                ('top5_feat_value', models.FloatField(blank=True, help_text='Value of top5 feature on this token', null=True)),
                ('status', models.CharField(default='PRED_ONLY', help_text='Result status (e.g., PRED_ONLY)', max_length=20)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token_addr', models.CharField(help_text='Token contract address', max_length=42)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reserve_quote_realized_vol', models.FloatField(blank=True, null=True)),
                ...
                ('token_info', models.ForeignKey(db_column='token_addr_idx', on_delete=django.db.models.deletion.CASCADE, related_name='exit_processed_static', to='api.tokeninfo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event_time', models.DateTimeField(help_text='Event occurrence timestamp')),
                ('tx_hash', models.CharField(help_text='Transaction hash', max_length=66)),
                ('delta_t_sec', models.FloatField(help_text='Time difference from previous event')),
                ('is_swap_event', models.IntegerField(help_text='1 if Swap event included, 0 otherwise')),
                ('lp_total_supply', models.FloatField(blank=True, help_text='Current LP total supply', null=True)),
                ('reserve_base_drop_frac', models.FloatField(blank=True, help_text='Base token decrease rate', null=True)),
                ('reserve_quote', models.FloatField(help_text='Current major token balance')),
                ('reserve_quote_drop_frac', models.FloatField(blank=True, help_text='Major token decrease rate', null=True)),
                ('price_ratio', models.FloatField(blank=True, help_text='Price ratio', null=True)),
                ('time_since_last_mint_sec', models.FloatField(blank=True, help_text='Time elapsed since last Mint (seconds)', null=True)),
                ('lp_minted_amount_per_sec', models.FloatField(blank=True, null=True)),
                ('lp_burned_amount_per_sec', models.FloatField(blank=True, null=True)),
                ...
                ('lp_total_supply_mask', models.FloatField(null=True)),
                ('reserve_quote_mask', models.FloatField(null=True)),
                ('price_ratio_mask', models.FloatField(null=True)),
                ('time_since_last_mint_sec_mask', models.FloatField(null=True)),
                ('token_info', models.ForeignKey(db_column='token_addr_idx', on_delete=django.db.models.deletion.CASCADE, related_name='exit_processed_instance', to='api.tokeninfo')),
            ],
            options={
                'db_table': 'exit_processed_data_instance',
                'ordering': ['token_info', 'event_time'],
                'indexes': [models.Index(fields=['token_info', 'event_time'], name='exit_proces_token_a_8e0f94_idx'), models.Index(fields=['tx_hash'], name='exit_proces_tx_hash_8cc242_idx')],
            },
        ),
        migrations.CreateModel(
            name='HolderInfo',
