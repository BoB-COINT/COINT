# Generated by Django 5.2.7 on 2025-12-09 08:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_unformed_lp",
                    models.IntegerField(default=0, help_text="Is not Unformed-LP"),
                ),
                (
                    "probability",
                    models.FloatField(
                        blank=True, help_text="Exit scam probability (0-1)", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_honeypot",
                    models.BooleanField(
                        help_text="Honeypot prediction result (y_pred)", null=True
                    ),
                ),
                (
                    "probability",
                    models.FloatField(
                        help_text="Honeypot probability (y_proba, 0-1)", null=True
                    ),
                ),
                (
                    "risk_level",
                ...
                (
                    "threshold",
                    models.FloatField(
                        blank=True, help_text="Decision threshold from model", null=True
                    ),
                ),
                (
                    "top1_feat",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "lp_total_supply",
                    models.FloatField(
                        blank=True, help_text="Current LP total supply", null=True
                    ),
                ),
                (
                ...
                (
                    "reserve_quote",
                    models.FloatField(help_text="Current major token balance"),
                ),
                (
