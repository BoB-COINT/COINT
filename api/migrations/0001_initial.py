        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(help_text="Base token decrease rate"),
                ),
                (
                    "reserve_quote",
                    models.DecimalField(
                ...
                (
                    ...
                    models.FloatField(help_text="Major token decrease rate"),
                ),
                ("price_ratio", models.FloatField(help_text="Price ratio")),
                (
                    "swap_sell_to_reserve_ratio",
                    models.FloatField(help_text="Base token inflow ratio to reserve"),
                ),
                (
                ...
                (
                    "price_ratio_delta_per_sec",
                    models.FloatField(help_text="Price ratio change rate per second"),
                ),
                (
                    "lp_supply_delta_per_sec",
                    models.FloatField(help_text="LP supply decrease rate per second"),
                ),
                (
                    "reserve_quote_delta_per_sec",
                    models.FloatField(
                ...
                (
                    ...
                    models.FloatField(help_text="LP minted amount per second"),
                ),
                (
                    "lp_burned_amount_per_sec",
                    models.FloatField(help_text="LP burned amount per second"),
                ),
                (
                    "swap_base_in_amount_per_sec",
                    models.FloatField(help_text="Base token inflow rate per second"),
                ),
                (
                    "swap_base_out_amount_per_sec",
                    models.FloatField(help_text="Base token outflow rate per second"),
                ),
                (
                    "swap_quote_in_amount_per_sec",
                    models.FloatField(help_text="Quote token inflow rate per second"),
                ),
                (
                    "swap_quote_out_amount_per_sec",
                    models.FloatField(help_text="Quote token outflow rate per second"),
                ),
                (
                    "token_info",
                    models.ForeignKey(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="exit_proces_token_a_20e5db_idx",
                    ),
                    models.Index(
                        fields=["tx_hash"], name="exit_proces_tx_hash_e9854f_idx"
                    ),
                ],
            },
        ),
